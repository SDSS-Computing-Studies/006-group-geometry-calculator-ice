...
def getParams(shape):
    ...
    if shape==1:
        ...
        x=("Enter the base l as length")
        y=("Enter the h as height")
        z=("Enter the base h as height")
        prompts=[x,y,z,1]
        return prompts
    elif shape ==3:
        x=("Enter the Radius")
        ...
        x=("Enter the Base l as length")
        y=("Enter the Base w as width")
        z=("Enter the h as height")
        prompts=[x,y,z,1] 
        return prompts
    elif shape==7:
        x=("Enter the Base edge")
...
def main():
    ...
    while run!=2:
        instructions()
        a=int(input("Pick which shape you would like to calculate"))
        b=getParams(a)
        c=getInputs(b)
        if a==1:
            answer=RectangularPrism(c)
            print(answer)
            run=int(input("If you want to End the program, enter 2. If not enter 1"))
        elif a==2:
